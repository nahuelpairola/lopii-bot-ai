...
|-------|-----------|-------|
| `users` | `id`, `username`, `deleted_at` | Soft delete. There is no admin flag (`is_admin` dropped in `20260926140000`) |
...
| `accounts` | `id`, `user_id`→users, `name`, `currency`, `is_default`, `deleted_at` | Unique index is case-insensitive on name (`20260704120000`) |

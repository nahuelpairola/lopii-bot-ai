...
// JustCreatedWindow: dentro de esta ventana, un mensaje SIN referente textual
// se resuelve al último movimiento cargado en vez de abrir un picker. Generosa
// a propósito — solo se consulta cuando no hay ninguna otra señal, y el confirm
// sigue pidiendo el OK del usuario. La comparten el near-duplicate gate (ver
// FindNearDuplicate) y la resolución de referencias del borde.

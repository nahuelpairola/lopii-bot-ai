	...
	return []AgentTool{
		...
		// ---- action: each one parks the request; the app takes it from there ----
		{
			...
			"properties": {
				...
				"date_to": {"type": ["string", "null"], "description": "Fecha de fin cuando el mensaje habla de un TRAMO, sea explícito (\"los gastos del 3 al 5\") o nombrado (\"la semana pasada\", \"el mes pasado\", \"en julio\"): ahí van SIEMPRE los dos extremos. YYYY-MM-DD o null; con date_from solo se busca en ese único día."}
			},

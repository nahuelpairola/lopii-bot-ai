...
var routerTool = toolSchema{
	...
	Parameters: json.RawMessage(`{
		"type": "object",
		"properties": {
			"intent": {"type": "string", "enum": ["CREATE", "UPDATE", "DELETE", "QUERY", "ACCOUNT_MANAGE", "CREATE_CATEGORY", "REMINDER_SET"]},
...
func (o *Orchestrator) ClassifyIntent(ctx context.Context, text string) (IntentResult, error) {
	...
	switch args.Intent {
	case IntentCreate, IntentUpdate, IntentDelete, IntentQuery, IntentAccountManage, IntentCreateCategory, IntentReminderSet:
